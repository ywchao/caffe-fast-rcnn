...
/**
 * @brief MultiLabelAccuracyLayer; adopted from sguada:multi-label-windows;
 *        originally used for multiple binary label accuracy; here I am using
 *        this just for single binary label case
 */
template <typename Dtype>
